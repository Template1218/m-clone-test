...
export default function MatchCard({
    ...
    >
      ...
      <span
        className={
          isBetSelected(market, sel)
            ? "text-black"
            : "text-brand-primary font-light text-[12px]"
        }
      >
        {odd.toFixed(2)}
      </span>
  ...
  return (
    <>
      ...
      >
        <div className="flex justify-between items-start">
          <div className="flex flex-col gap-1">
            <h3 className="text-[13px] font-black text-white italic uppercase tracking-tight">
              {match.homeTeam}
            </h3>
            <h3 className="text-[13px] font-black text-white italic uppercase tracking-tight">
              {match.awayTeam}
          ...
          <div className="flex flex-col items-end gap-1">
            <span className="text-[10px] font-black text-[#525252] tabular-nums tracking-wide">
        ...
        <div className="flex gap-1.5 h-10">
          <button
            onClick={(e) => {
              e.stopPropagation();
              onToggleBet(match, "Match Result", "1", match.odds.home);
            }}
          ...
          >
            ...
            <span
              className={`text-[12px] font-black ${isBetSelected("Match Result", "1") ? "text-black" : "text-brand-primary"}`}
            >
          ...
          <button
            onClick={(e) => {
              e.stopPropagation();
              onToggleBet(match, "Match Result", "X", match.odds.draw);
            }}
          ...
          >
            ...
            <span
              className={`text-[12px] font-black ${isBetSelected("Match Result", "X") ? "text-black" : "text-brand-primary"}`}
            >
          ...
          <button
            onClick={(e) => {
              e.stopPropagation();
              onToggleBet(match, "Match Result", "2", match.odds.away);
            }}
          ...
          >
            ...
            <span
              className={`text-[12px] font-black ${isBetSelected("Match Result", "2") ? "text-black" : "text-brand-primary"}`}
            >
      ...
      {/* Desktop Card Layout */}
      <div
        className={`hidden lg:flex flex-col border-b border-white/[0.05] hover:bg-white/[0.01] transition-all cursor-pointer group/card p-1 px-6  ${
          isSelected
      ...
      >
        ...
        <div className="flex items-center justify-between">
          <div
            className={`font-normal text-white truncate group-hover/card:text-brand-primary transition-all ${isCompact ? "text-[12px]" : "text-[14px]"}`}
          >
